        ...
        <div class="card-body">
                ...
                <div class="col-md-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>: 
                                @if($pembelian->status == \App\Models\Pembelian::STATUS_BELUM_BAYAR)
            ...
            @foreach($pembelian->pembelianDetails as $detail)
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tfoot class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ number_format($detail->timbangan->total_jumlah_ekor ?? 0) }} ekor</th>
                                        <th class="text-right">{{ number_format($detail->timbangan->total_berat ?? 0, 2) }} kg</th>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 offset-md-3">
                        <div class="card {{ $pembelian->status == \App\Models\Pembelian::STATUS_SUDAH_BAYAR ? 'border-success' : 'border-secondary' }}">
                            <div class="card-header {{ $pembelian->status == \App\Models\Pembelian::STATUS_SUDAH_BAYAR ? 'bg-success' : 'bg-secondary' }} text-white">
                                <h6 class="mb-0">
                                    <i class="fas fa-dollar-sign"></i> 
                                    {{ $pembelian->status == \App\Models\Pembelian::STATUS_SUDAH_BAYAR ? 'Detail Pembayaran' : 'Belum Ada Pembayaran' }}
                                </h6>
                            </div>
                            <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12 d-flex justify-content-end">
                    ...
                    @if($pembelian->status != \App\Models\Pembelian::STATUS_SUDAH_BAYAR)
                        <a href="{{ route('pembelian.edit', $pembelian->id) }}" class="btn btn-warning ml-2">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <form action="{{ route('pembelian.destroy', $pembelian->id) }}" method="POST" class="d-inline ml-2">
                            @csrf
                            @method('DELETE')
